...
from wast import parametrize, register_step
from wast._exceptions import BaseWastException
from wast._pipeline import Pipeline, set_pipeline
from wast._steps.handlers import BaseStepHandler, StepGroupHandler, StepHandler
from wast._steps.registration import register_managed_step
...
def test_handles_step_with_no_name(pipeline):
    ...
    with pytest.raises(BaseWastException) as exc_wrapper:
