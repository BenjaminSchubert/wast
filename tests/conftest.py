...
from wast import Config, predefined
from wast.__main__ import main
from wast._pipeline import Pipeline, set_pipeline
from wast._subproc import set_subprocess_default_pipes
...
def ensure_defaults_are_untouched(tmp_path_factory):
    ...
    def extract_defaults():
        return {name: step.__wast_defaults__ for name, step in steps.items()}
