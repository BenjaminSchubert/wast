...
def pytest(
    *,
    ...
    :param args: arguments to pass to the ``pytest`` invocation.
                 Defaults to :python:`[]`.
    :param parametrize: A :py:func:`wast.parametrize` invocation to apply on
                        the step.
    ...
    .. seealso::
        ...
        How to parametrize methods with :py:func:`wast.parametrize`
    ...
    :Examples:
        ...
        .. code-block::
            ...
            wast.predefined.pytest(
                ...
                requires=["package"],
                parametrize=wast.parametrize("python", ["3.8", "3.9", "3.10"])
            )
