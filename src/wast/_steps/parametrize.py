...
_DEFAULTS = "__wast_defaults__"
_PARAMETERS = "__wast_parameters__"


class ParameterConflictException(BaseWastException):
    """
...
class DefaultsAlreadySetException(BaseWastException):
    """
...
class MismatchedNumberOfParametersException(BaseWastException):
    """
